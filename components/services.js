...
function render() {
  return h('div#servicesPage', [
    ...
    h("div.page-container", [
      ...
      h("div", {
        'data-ng-if': 'currentService.fields.pageTitle === "Architecture"'
          ...
          h("div.row", [h("div.col-sm-12", {
              ...
              h("h1.mg-md.text-center.tc-white", "{{currentService.fields.pageTitle}}", {'style': 'text-transform:uppercase'})
            ])])
        ])]),
      h("div", {
      ...
      h("div.closeNav", [h("div#bloc-2.bloc.bg-Halftone-Pattern.tc-prussian-blue.bgc-white", {
          "style": "background-color:#F6F6F6;-webkit-box-shadow:inset 0 10px 5px 2px rgba(0,0,0,.05);box-shadow:inset 0 -3px 8px 4px rgba(0,0,0,.05)"
              ...
              h("div.col-md-4.col-cd-offset-1.col-xs-12.serv", [h("div#over", [
                  h("span.Centerer"),
              ...
              h('.col-md-7.col-xs-12', [
                h('p.text-left', {'data-marked': 'currentService.fields.description'}),
                h('br'),
                h('br')
              ])
            ])])])])
