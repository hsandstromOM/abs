      ...
      h("div", {
        'data-ng-if': 'currentServiceProvided.fields.pageTitle === "Architecture"'
          ...
          h("div.row", [h("div.col-sm-12", {
              ...
              h("h1.mg-md.text-center.tc-white.ng-binding", "{{currentServiceProvided.fields.pageTitle}}", {'style': 'text-transform:uppercase'})
            ])])
        ])]),
      h("div", {
        ...
        h("div#bloc-12.bloc.bg-Halftone-Pattern.tc-prussian-blue.bgc-white", {
          'style': 'background-color:#F6F6F6;'
            ...
            'style': 'padding-right:5%;padding-left:5%;'
              ...
              h("div.col-sm-4", [h("div.shadow", [h("div.hexContainerWork", [h(".hexThumbWork", {
                      "data-ui-sref": "workDetail({slug: workProject.fields.slug})",
                      "style": "cursor:pointer"
                    }, [h("img", {"data-ng-src": "{{workProject.fields.thumbnailImage.fields.file.url}}"})])])])]),
              h("div.work.col-sm-8", {}, [
                h('br'),
                h("h2.mg-md.tc-prussian-blue", {'data-marked': 'workProject.fields.title'}),
                h("p", {
